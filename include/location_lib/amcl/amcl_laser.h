 ...
 * @LastEditTime: 2022-10-01 16:02:06
 */
/*
...
#include "include/location_lib/amcl/amcl_sensor.h"
...
class AMCLLaser : public AMCLSensor {
 ...
 public:
  void SetLaserPose(const pf_vector_t &laser_pose) { this->laser_pose = laser_pose; }
