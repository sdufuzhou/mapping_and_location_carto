...
#ifndef PLUGINS_MAPPING_LIB_INCLUDE_KARTO_MAPPING_TYPES_H_
#define PLUGINS_MAPPING_LIB_INCLUDE_KARTO_MAPPING_TYPES_H_
...
#endif // PLUGINS_MAPPING_LIB_INCLUDE_KARTO_MAPPING_TYPES_H_
