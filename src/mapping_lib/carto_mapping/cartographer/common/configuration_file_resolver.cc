...
ConfigurationFileResolver::ConfigurationFileResolver(
  ...
  configuration_files_directories_.push_back(kConfigurationFilesDirectory);//参数追加
}//传入的参数 configuration_files_directories(配置文件目录) 直接赋值给 configuration_files_directories_
